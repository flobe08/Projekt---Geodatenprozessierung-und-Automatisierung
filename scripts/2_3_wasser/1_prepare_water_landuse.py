...
3. Build three water-specific output layers.
4. Save each category as its own GeoPackage for QGIS and manual validation.

Hinweis:
Für Wasser ist Landnutzung eher eine Kontextinformation. Die fachlich
wichtigeren Eingangsdaten werden später eher Gewässer, Schutzgebiete und
Überschwemmungsflächen sein.
"""
...
# =============================================================================
# Ausschluss:
# Wohnnutzung, öffentliche Einrichtungen und klassische Freizeit- und
# Verkehrsflächen sollen auch bei Wasser nicht als Suchraum behandelt werden.
WASSER_AUSSCHLUSS = {
    "ln_wohnnutzung",
    "ln_bestattung",
...
# Kontext:
# Diese Nutzungen sind für Wasser fachlich interessant, ohne schon allein eine
# direkte Eignung zu garantieren. Output aktuell nicht direkt in der finalen
# Karte verwendet.
WASSER_KONTEXT = {
    "ln_wasserwirtschaft",
...
# Geeignet:
# Vorläufige Kernmenge für wasserbezogene oder wenig überbaute Flächen.
